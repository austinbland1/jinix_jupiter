...
module jupiter_cpu_dma_mmio_tb;
    ...
    initial begin
        ...
        dut.ram.memory[0]  = enc_i(8'h10, 5'd1, 5'd0, 14'd4608);
        dut.ram.memory[1]  = enc_i(8'h10, 5'd2, 5'd0, 14'd42);
        dut.ram.memory[2]  = enc_s(8'h21, 5'd2, 5'd1, 14'd8);
        dut.ram.memory[3]  = enc_i(8'h20, 5'd3, 5'd1, 14'd8);
        dut.ram.memory[4]  = enc_i(8'h10, 5'd4, 5'd0, 14'd84);
        dut.ram.memory[5]  = enc_s(8'h21, 5'd4, 5'd1, 14'd12);
        dut.ram.memory[6]  = enc_i(8'h20, 5'd5, 5'd1, 14'd12);
        dut.ram.memory[7]  = enc_s(8'h21, 5'd0, 5'd1, 14'd16);
        dut.ram.memory[8]  = enc_i(8'h20, 5'd9, 5'd1, 14'd16);
        dut.ram.memory[9]  = enc_i(8'h10, 5'd6, 5'd0, 14'd1);
        dut.ram.memory[10] = enc_s(8'h21, 5'd6, 5'd1, 14'd0);
        dut.ram.memory[11] = enc_i(8'h20, 5'd7, 5'd1, 14'd4);
        dut.ram.memory[12] = enc_i(8'h20, 5'd8, 5'd1, 14'd32);
        dut.ram.memory[13] = enc_n(8'hFF);
