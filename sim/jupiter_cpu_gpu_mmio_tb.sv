...
module jupiter_cpu_gpu_mmio_tb;
    ...
    initial begin
        ...
        dut.ram.memory[0] = enc_i(8'h10, 5'd1, 5'd0, 14'd4352);
        ...
        dut.ram.memory[4] = enc_i(8'h10, 5'd4, 5'd0, 14'd1);
        dut.ram.memory[5] = enc_s(8'h21, 5'd4, 5'd1, 14'd0);
        dut.ram.memory[6] = enc_i(8'h20, 5'd5, 5'd1, 14'd4);
        dut.ram.memory[7] = enc_i(8'h20, 5'd6, 5'd1, 14'd32);
        dut.ram.memory[8] = enc_n(8'hFF);
