...
module jupiter_cpu_controller_mmio_tb;
    ...
    initial begin
        ...
        dut.ram.memory_b0[0] = (enc_i(8'h10, 5'd1, 5'd0, 14'd5120));
        dut.ram.memory_b1[0] = ((enc_i(8'h10, 5'd1, 5'd0, 14'd5120)) >> 8);
        dut.ram.memory_b2[0] = ((enc_i(8'h10, 5'd1, 5'd0, 14'd5120)) >> 16);
        dut.ram.memory_b3[0] = ((enc_i(8'h10, 5'd1, 5'd0, 14'd5120)) >> 24);

        dut.ram.memory_b0[1] = (enc_i(8'h20, 5'd2, 5'd1, 14'd0));
        dut.ram.memory_b1[1] = ((enc_i(8'h20, 5'd2, 5'd1, 14'd0)) >> 8);
        dut.ram.memory_b2[1] = ((enc_i(8'h20, 5'd2, 5'd1, 14'd0)) >> 16);
        dut.ram.memory_b3[1] = ((enc_i(8'h20, 5'd2, 5'd1, 14'd0)) >> 24);

        dut.ram.memory_b0[2] = (enc_i(8'h20, 5'd3, 5'd1, 14'd4));
        dut.ram.memory_b1[2] = ((enc_i(8'h20, 5'd3, 5'd1, 14'd4)) >> 8);
        dut.ram.memory_b2[2] = ((enc_i(8'h20, 5'd3, 5'd1, 14'd4)) >> 16);
        dut.ram.memory_b3[2] = ((enc_i(8'h20, 5'd3, 5'd1, 14'd4)) >> 24);

        dut.ram.memory_b0[3] = (enc_i(8'h20, 5'd4, 5'd1, 14'd8));
        dut.ram.memory_b1[3] = ((enc_i(8'h20, 5'd4, 5'd1, 14'd8)) >> 8);
        dut.ram.memory_b2[3] = ((enc_i(8'h20, 5'd4, 5'd1, 14'd8)) >> 16);
        dut.ram.memory_b3[3] = ((enc_i(8'h20, 5'd4, 5'd1, 14'd8)) >> 24);

        dut.ram.memory_b0[4] = (enc_i(8'h20, 5'd5, 5'd1, 14'd12));
        dut.ram.memory_b1[4] = ((enc_i(8'h20, 5'd5, 5'd1, 14'd12)) >> 8);
        dut.ram.memory_b2[4] = ((enc_i(8'h20, 5'd5, 5'd1, 14'd12)) >> 16);
        dut.ram.memory_b3[4] = ((enc_i(8'h20, 5'd5, 5'd1, 14'd12)) >> 24);

        dut.ram.memory_b0[5] = (enc_i(8'h20, 5'd6, 5'd1, 14'd16));
        dut.ram.memory_b1[5] = ((enc_i(8'h20, 5'd6, 5'd1, 14'd16)) >> 8);
        dut.ram.memory_b2[5] = ((enc_i(8'h20, 5'd6, 5'd1, 14'd16)) >> 16);
        dut.ram.memory_b3[5] = ((enc_i(8'h20, 5'd6, 5'd1, 14'd16)) >> 24);

        dut.ram.memory_b0[6] = (enc_i(8'h20, 5'd7, 5'd1, 14'd20));
        dut.ram.memory_b1[6] = ((enc_i(8'h20, 5'd7, 5'd1, 14'd20)) >> 8);
        dut.ram.memory_b2[6] = ((enc_i(8'h20, 5'd7, 5'd1, 14'd20)) >> 16);
        dut.ram.memory_b3[6] = ((enc_i(8'h20, 5'd7, 5'd1, 14'd20)) >> 24);

        dut.ram.memory_b0[7] = (enc_i(8'h20, 5'd8, 5'd1, 14'd24));
        dut.ram.memory_b1[7] = ((enc_i(8'h20, 5'd8, 5'd1, 14'd24)) >> 8);
        dut.ram.memory_b2[7] = ((enc_i(8'h20, 5'd8, 5'd1, 14'd24)) >> 16);
        dut.ram.memory_b3[7] = ((enc_i(8'h20, 5'd8, 5'd1, 14'd24)) >> 24);

        dut.ram.memory_b0[8] = (enc_i(8'h10, 5'd9, 5'd0, 14'd123));
        dut.ram.memory_b1[8] = ((enc_i(8'h10, 5'd9, 5'd0, 14'd123)) >> 8);
        dut.ram.memory_b2[8] = ((enc_i(8'h10, 5'd9, 5'd0, 14'd123)) >> 16);
        dut.ram.memory_b3[8] = ((enc_i(8'h10, 5'd9, 5'd0, 14'd123)) >> 24);

        dut.ram.memory_b0[9] = (enc_s(8'h21, 5'd9, 5'd1, 14'd0));
        dut.ram.memory_b1[9] = ((enc_s(8'h21, 5'd9, 5'd1, 14'd0)) >> 8);
        dut.ram.memory_b2[9] = ((enc_s(8'h21, 5'd9, 5'd1, 14'd0)) >> 16);
        dut.ram.memory_b3[9] = ((enc_s(8'h21, 5'd9, 5'd1, 14'd0)) >> 24);

        dut.ram.memory_b0[10] = (enc_i(8'h20, 5'd10, 5'd1, 14'd0));
        dut.ram.memory_b1[10] = ((enc_i(8'h20, 5'd10, 5'd1, 14'd0)) >> 8);
        dut.ram.memory_b2[10] = ((enc_i(8'h20, 5'd10, 5'd1, 14'd0)) >> 16);
        dut.ram.memory_b3[10] = ((enc_i(8'h20, 5'd10, 5'd1, 14'd0)) >> 24);

        dut.ram.memory_b0[11] = (enc_n(8'hFF));
        dut.ram.memory_b1[11] = ((enc_n(8'hFF)) >> 8);
        dut.ram.memory_b2[11] = ((enc_n(8'hFF)) >> 16);
        dut.ram.memory_b3[11] = ((enc_n(8'hFF)) >> 24);
