...
module jupiter_gpu_dma_contention_tb;
    ...
    initial begin
        ...
        dut.ram.memory[18] =
            enc_i(8'h10, 5'd11, 5'd0, 14'd4608);
        ...
        dut.ram.memory[24] =
            enc_i(8'h10, 5'd7, 5'd1, 14'd4096);

        dut.ram.memory[25] =
            enc_i(8'h10, 5'd8, 5'd1, 14'd4608);

        dut.ram.memory[26] =
            enc_i(8'h10, 5'd9, 5'd0, 14'd64);

        dut.ram.memory[27] =
            enc_i(8'h10, 5'd13, 5'd0, 14'd2);
        ...
        // DMA configuration.
        dut.ram.memory[32] =
            enc_s(8'h21, 5'd7, 5'd11, 14'd8);

        dut.ram.memory[33] =
            enc_s(8'h21, 5'd8, 5'd11, 14'd12);

        dut.ram.memory[34] =
            enc_s(8'h21, 5'd9, 5'd11, 14'd16);
